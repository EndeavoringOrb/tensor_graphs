...
def test_slice_basic_1d():
    ...
    slice_node = TensorNode(OpType.SLICE, (2,), DType.FP32, [data_node, starts_node, ends_node, steps_node], "slice")
...
def test_slice_multi_dim():
    ...
    slice_node = TensorNode(OpType.SLICE, (2, 2), DType.FP32, [data_node, starts_node, ends_node, steps_node], "slice")
