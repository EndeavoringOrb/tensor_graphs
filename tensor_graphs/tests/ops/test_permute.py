...
def test_permute_matrix_transpose():
    ...
    permute_node = TensorNode(OpType.PERMUTE, (3, 2), DType.FP32, [data_node, perm_node], "permute")
...
def test_permute_3d_reorder():
    ...
    permute_node = TensorNode(OpType.PERMUTE, (4, 2, 3), DType.FP32, [data_node, perm_node], "permute")
