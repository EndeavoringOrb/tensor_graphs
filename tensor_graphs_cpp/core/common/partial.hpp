...
inline void compute_slice_shape(const std::vector<uint32_t> &out_shape, const int32_t *starts, const int32_t *ends,
                                const int32_t *steps, uint32_t starts_size, uint32_t ends_size, uint32_t steps_size,
