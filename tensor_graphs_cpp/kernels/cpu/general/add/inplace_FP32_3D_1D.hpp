...
REGISTER_KERNEL_INPLACE("Add_3D_1D_inplace", 2, 2, matchAddFP32_3D_1D_Inplace, runAddFP32_3D_1D_Inplace,
                        refFactoryAdd3D_1D_Inplace, MemSpace(1, HandleType::CPP), {Engine(0, EngineType::CPU)},
