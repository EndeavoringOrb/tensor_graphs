...
REGISTER_KERNEL("Add_NC_F32_ND", 2, {Backend::CPU}, matchAddNC_F32_ND, runAddNC_F32_ND, refFactoryAddNC_F32_ND, {DType::FLOAT32, DType::FLOAT32}, {{1, 1, 1}, {1, 1, 1}}, {false, false});