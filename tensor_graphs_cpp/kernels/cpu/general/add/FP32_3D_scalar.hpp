...
REGISTER_KERNEL("Add_3D_Scalar", 2, matchAddFP32_3D_Scalar, runAddFP32_3D_Scalar, refFactoryAdd3D_Scalar, {Backend::CPU}, {DType::FLOAT32, DType::FLOAT32}, {{1, 128, 640}, {1}}, {true, true});