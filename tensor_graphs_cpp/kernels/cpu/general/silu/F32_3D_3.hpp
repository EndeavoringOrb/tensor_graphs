...
inline void runSiluF32_3(const KernelContext &ctx)
{
...
inline LogicalId refFactorySilu_3(const std::vector<LogicalId> &inputs, Graph &graph)
{
    ...
    LogicalId e_node = ref_silu_broadcast_scalar_3(graph, graph.constant({1}, &e_val, DType::FLOAT32), target_shape);
...
REGISTER_KERNEL("Silu_3D_3", 1, 1, matchSiluF32_3, runSiluF32_3, refFactorySilu_3, {0}, MemSpace(1, HandleType::CPP),
