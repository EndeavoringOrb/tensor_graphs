...
inline bool matchScatterF32_ND_Inplace_Fast(const std::vector<TensorNode> &inputs, const TensorNode &output)
{
    ...
    // Ensure index parameters (starts, ends, steps) match the tensor rank
...
REGISTER_KERNEL("SCATTER_inplace_fast", 5, 5, matchScatterF32_ND_Inplace_Fast, runInplaceScatterF32_ND_Fast,
                refFactoryScatterF32_ND_Inplace_Fast, {0}, MemSpace(1, HandleType::CPP), {Engine(0, EngineType::CPU)},
