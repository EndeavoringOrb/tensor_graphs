...
REGISTER_KERNEL("Scatter_Dot_F32_3D_CPU_Optimized_inplace", 12, 12, matchScatterDotF32_3D_Optimized_Inplace,
                runScatterDotF32_3D_Optimized_Inplace, refFactoryScatterDotF32_3D_Optimized_Inplace, {0},
                MemSpace(1, HandleType::CPP), {Engine(0, EngineType::CPU)},
                {DType::FLOAT32, DType::FLOAT32, DType::FLOAT32, DType::INT32, DType::INT32, DType::INT32, DType::INT32,
