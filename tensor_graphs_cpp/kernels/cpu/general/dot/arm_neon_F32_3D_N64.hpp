...
inline bool matchDotF32_3D_N64(const std::vector<TensorNode> &inputs, const TensorNode &output)
{
    ...
    // Both B and Out must have stride-1 on the last dimension for contiguous
    // vector loads
...
inline void runDotF32_3D_N64(const KernelContext &ctx)
{
    ...
    ThreadPool::get().parallel_for(num_threads, [=](uint32_t t)
            ...
            // K_BLK = 128 perfectly sizes B block (32 KB) + A block (30 KB) + C block
            // (15 KB) protecting L1d cache (96 KB) from sweeps leading to conflict
            // evictions.
            const uint32_t K_BLK = 128;
            const uint32_t M_BLK = 60; // Multiple of 6 ensures unrolled M-loop
                                       // avoids tail logic entirely
                        ...
                        for (; m + 5 < m_blk_end; m += 6)
                        {
                            ...
                            for (uint32_t n = 0; n < 64; n += 16)
                            {
                                ...
                                else
                                {
                                    ...
                                    c40 = vld1q_f32(o4_ptr + n + 0);
                                    c41 = vld1q_f32(o4_ptr + n + 4);
                                    c42 = vld1q_f32(o4_ptr + n + 8);
                                    c43 = vld1q_f32(o4_ptr + n + 12);
                                    c50 = vld1q_f32(o5_ptr + n + 0);
                                    c51 = vld1q_f32(o5_ptr + n + 4);
                                    c52 = vld1q_f32(o5_ptr + n + 8);
                                    c53 = vld1q_f32(o5_ptr + n + 12);
                                }
                                ...
                                vst1q_f32(o4_ptr + n + 0, c40);
                                vst1q_f32(o4_ptr + n + 4, c41);
                                vst1q_f32(o4_ptr + n + 8, c42);
                                vst1q_f32(o4_ptr + n + 12, c43);
                                vst1q_f32(o5_ptr + n + 0, c50);
                                vst1q_f32(o5_ptr + n + 4, c51);
                                vst1q_f32(o5_ptr + n + 8, c52);
                                vst1q_f32(o5_ptr + n + 12, c53);
                            }
                        }
                        ...
                        for (; m < m_blk_end; ++m)
                        {
                            ...
                            for (uint32_t n = 0; n < 64; n += 16)
                            {
                                ...
                                for (; k + 1 < k_end; k += 2)
                                {
                                    ...
                                    c0 = vfmaq_f32(c0, b0, a0);
                                    c1 = vfmaq_f32(c1, b1, a0);
                                    c2 = vfmaq_f32(c2, b2, a0);
                                    c3 = vfmaq_f32(c3, b3, a0);
                                    p_b += strideB_K;
                                    p_a += strideA_K;
