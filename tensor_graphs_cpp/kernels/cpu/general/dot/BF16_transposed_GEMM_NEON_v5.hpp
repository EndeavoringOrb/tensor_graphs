...
REGISTER_KERNEL("BF16_Transposed_GEMM_NEON_v5", 2, matchBF16TransposedGEMM_v5, runBF16TransposedGEMM_v5, refFactoryBF16TransposedGEMM_v5, {Backend::CPU}, {DType::FLOAT32, DType::BF16}, {{1, 8, 640}, {262144, 640}}, {true, true}, {{Backend::CPU}, {Backend::CPU}});
#endif