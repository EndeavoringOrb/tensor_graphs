...
REGISTER_KERNEL("BF16_Transposed_GEMM_NEON_v2", 2, matchBF16TransposedGEMM_v2, runBF16TransposedGEMM_v2, refFactoryBF16TransposedGEMM_v2, {Backend::CPU}, {DType::FLOAT32, DType::BF16}, {{1, 8, 64}, {1024, 64}}, {true, true}, {{Backend::CPU}, {Backend::CPU}});
#endif