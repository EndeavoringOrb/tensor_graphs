...
REGISTER_KERNEL("BF16_Transposed_GEMM_NEON_v3", 2, matchBF16TransposedGEMM_v3, runBF16TransposedGEMM_v3, refFactoryBF16TransposedGEMM_v3, {Backend::CPU}, {DType::FLOAT32, DType::BF16}, {{1, 8, 64}, {1024, 64}}, {true, true}, {{Backend::CPU}, {Backend::CPU}});
#endif