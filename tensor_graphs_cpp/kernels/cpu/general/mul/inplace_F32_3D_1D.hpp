...
REGISTER_KERNEL("Mul_3D_1D_inplace", 2, 2, matchMulFP32_3D_1D_Inplace, runMulFP32_3D_1D_Inplace,
                refFactoryMul3D_1D_Inplace, {0}, MemSpace(1, HandleType::CPP), {Engine(0, EngineType::CPU)},
