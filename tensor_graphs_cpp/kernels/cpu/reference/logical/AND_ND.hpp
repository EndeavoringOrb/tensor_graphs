...
REGISTER_REF_KERNEL(OpType::AND, 2, 2, matchAnd_ND, runAnd_ND, MemSpace(1, HandleType::CPP), {Engine(0, EngineType::CPU)}, {DType::BOOL, DType::BOOL}, {{8, 32}, {8, 32}}, {true, true}, {{MemSpace(1, HandleType::CPP)}, {MemSpace(1, HandleType::CPP)}});
