...
REGISTER_REF_KERNEL(OpType::ARANGE, 3, 3, matchArangeI32_ND, runArangeI32_ND, MemSpace(1, HandleType::CPP),
                    {Engine(0, EngineType::CPU)}, {DType::INT32, DType::INT32, DType::INT32}, {{1}, {1}, {1}},
                    {false, false, false},
