...
REGISTER_REF_KERNEL(OpType::LOG, 1, 1, matchLogF32_ND, runLogF32_ND, MemSpace(1, HandleType::CPP), {Engine(0, EngineType::CPU)}, {DType::FLOAT32}, {{8, 32}}, {true}, {{MemSpace(1, HandleType::CPP)}});