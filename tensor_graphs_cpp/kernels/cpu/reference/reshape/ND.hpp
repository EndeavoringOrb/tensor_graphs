...
REGISTER_REF_KERNEL_VIEW(OpType::RESHAPE, 2, matchReshapeView, inferViewReshape, {Backend::CPU, Backend::CUDA}, {}, {{1}, {1}}, {true, true}, {{Backend::CPU, Backend::CUDA}, {Backend::CPU}});
