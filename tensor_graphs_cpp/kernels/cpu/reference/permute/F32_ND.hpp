...
REGISTER_REF_KERNEL_VIEW(OpType::PERMUTE, 2, matchPermuteView, inferViewPermute, {Backend::CPU, Backend::CUDA}, {}, {{1}, {1}}, {false, false}, {{Backend::CPU, Backend::CUDA}, {Backend::CPU}});
