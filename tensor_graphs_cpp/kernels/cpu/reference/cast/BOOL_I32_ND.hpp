...
REGISTER_REF_KERNEL(OpType::CAST, 1, 1, matchCastBOOL_I32_ND, runCastBOOL_I32_ND, MemSpace(1, HandleType::CPP), {Engine(0, EngineType::CPU)}, {DType::BOOL}, {{8, 32}}, {true}, {{MemSpace(1, HandleType::CPP)}});
