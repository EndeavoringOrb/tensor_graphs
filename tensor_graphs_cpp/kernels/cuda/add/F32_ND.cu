...
inline void runAddF32_CUDA_ND(const KernelContext &ctx) {
    ...
    add_f32_nd_kernel<<<numBlocks, blockSize, 0, stream>>>(A, B, Out, n);
...
REGISTER_KERNEL("Add_F32_ND_CUDA", 2, 2, matchAddF32_CUDA_ND, runAddF32_CUDA_ND, refFactoryAddF32_ND_CUDA,{0,1}, MemSpace(2, HandleType::CUDA), {Engine(0, EngineType::CUDA_GPU)}, {DType::FLOAT32, DType::FLOAT32}, {{1024}, {1024}}, {true, true}, {{MemSpace(2, HandleType::CUDA)}, {MemSpace(2, HandleType::CUDA)}});
