...
REGISTER_KERNEL("Dot_F32_3D_OpenCL_v1", 2, 2, matchDotF32_3D_OpenCL_v1, runDotF32_3D_OpenCL_v1,
                refFactoryDotF32_3D_OpenCL_v1, MemSpace(1, HandleType::OPENCL), {Engine(0, EngineType::QUALCOMM_IGPU)},
