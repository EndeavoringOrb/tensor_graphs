...
inline uint32_t refFactoryDotF32_3D_OpenCL_v1(const std::vector<uint32_t> &inputs, Graph &graph)
{
    return graph.dot(inputs[0], inputs[1]);
}

REGISTER_KERNEL("Dot_F32_3D_OpenCL_v1", 2, matchDotF32_3D_OpenCL_v1, runDotF32_3D_OpenCL_v1, refFactoryDotF32_3D_OpenCL_v1, {Backend::OPENCL}, {DType::FLOAT32, DType::FLOAT32}, {{1, 16, 32}, {1, 32, 16}}, {true, true}, {{Backend::OPENCL}, {Backend::OPENCL}});