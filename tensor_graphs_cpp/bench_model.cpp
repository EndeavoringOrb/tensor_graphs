...
int main(int argc, char *argv[])
{
    ...
    if (cache_file.empty())
    {
        ...
        std::string prefix = settings.use_ortools_lns ? "bench_ortools_lns_" : (settings.use_ortools_full ? "bench_ortools_full_" : (settings.use_ortools ? "bench_ortools_" : "bench_"));
