...
def test_reshape_vector_to_matrix():
    ...
    data_node = TensorNode(OpType.INPUT, (6,), DType.FP32, [], "data")
    shape_node = TensorNode(OpType.INPUT, (2,), DType.INT32, [], "target_shape")

    reshape_node = TensorNode(
        OpType.RESHAPE, (2, 3), DType.FP32, [data_node, shape_node], "reshape"
    )
...
def test_reshape_3d_to_flattened():
    ...
    data_node = TensorNode(OpType.INPUT, (2, 2, 2), DType.FP32, [], "data")
    shape_node = TensorNode(OpType.INPUT, (1,), DType.INT32, [], "target_shape")

    reshape_node = TensorNode(
        OpType.RESHAPE, (8,), DType.FP32, [data_node, shape_node], "reshape"
    )
...
def test_reshape_with_inference():
    ...
    # We want (3, 2)
    reshape_node = TensorNode(
        OpType.RESHAPE, (3, 2), DType.FP32, [data_node, shape_node], "reshape"
    )
