...
def main():
    ...
    parser.add_argument("--model", type=str, default="gemma-3-270m", help="gemma-3-270m, qwen-3.6-35b-a3b, deepseek-v4")
    parser.add_argument("--model-path", type=str, default="models/google/gemma-3-270m")
    parser.add_argument("--run-dir", type=str, default=None, help="Path to runs/N to load the agent from")
